...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/league/:package_name.svg?style=flat-square)](https://packagist.org/packages/webvolant/abadmin)
...
``` bash
$ composer require webvolant/abadmin
```
